    ...
    : QWidget(parent)
{
    ...
    m_pMinimizeButton->setIcon(QIcon(":/new/pic/mini.ico"));
    m_pMaximizeButton->setIcon(QIcon(":/new/pic/show.ico"));
    m_pCloseButton->setIcon(QIcon(":/new/pic/close.ico"));

    m_pMinimizeButton->setDefault(true);
    m_pMaximizeButton->setDefault(true);
